...
# @app.post("/post")
# def create_post(post:schemas.CourseCreate):
#     try:
#         cursor.execute(
...
@app.get("/coursealchemy", response_model= List[schemas.CourseCreate])
def course(db:Session = Depends(get_db)):
    courses = db.query(models.Course).all()
    return courses


@app.get("/coursealchemy/{id}", response_model=schemas.CourseCreate)
...
@app.put("/aiquest_course/{id}", response_model=schemas.CourseResponse)
